...
ActiveRecord::Schema[7.0].define(version: 2023_10_04_120040) do
  ...
  create_table "delivery_addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_delivery_addresses_on_purchase_history_id"
  end
  ...
  add_foreign_key "delivery_addresses", "purchase_histories"
